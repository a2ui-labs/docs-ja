...
|----------|----------|------|------|-------|
| **React** | Web | ✅ 安定版 | ❌ | [コード](https://github.com/google/A2UI/tree/main/renderers/react) |
| **Lit (Web Components)** | Web | ✅ 安定版 | ✅ 安定版 | [コード](https://github.com/google/A2UI/tree/main/renderers/lit) |
| **Angular** | Web | ✅ 安定版 | ✅ 安定版 | [コード](https://github.com/google/A2UI/tree/main/renderers/angular) |
| **Flutter (GenUI SDK)** | モバイル/デスクトップ/Web | ✅ 安定版 | ✅ 安定版 | [ドキュメント](https://docs.flutter.dev/ai/genui) · [コード](https://github.com/flutter/genui) |
