...
![エージェントとレンダラー](assets/agent-and-renderer.png)
...
[basic catalog](../specification/v0_10/catalogs/basic/catalog.json) を参照してください。
...
- **Catalog Schema**:
    ...
    例として [basic catalog schema](../specification/v0_10/catalogs/basic/catalog.json) を参照してください。
...
[data flow guide](concepts/data-flow.md) を参照してください。
...
[data binding guide](concepts/data-binding.md) を参照してください。

### データ参照

コンポーネント定義内でのデータ要素への参照です。データモデル内の path または値として解決できます。

[basic catalog の例](../specification/v0_10/catalogs/basic/catalog.json#L18) を参照してください。
...
[actions の詳細ガイド](concepts/actions.md) を参照してください。
